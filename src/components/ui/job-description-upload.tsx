    ...
    <div className={cn("w-full", className)}>
      ...
      >
        ...
        <div className="space-y-2 sm:space-y-3">
          {!selectedFile ? (
            <>
              <div className="mx-auto w-10 sm:w-10 h-10 sm:h-10 text-red-500">
            ...
            <div className="space-y-2">
              <div className="mx-auto w-8 sm:w-10 h-8 sm:h-10 text-green-500 bg-green-500/10 rounded-full flex items-center justify-center">
                <svg className="w-5 sm:w-5 h-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                ...
                className="px-2.5 sm:px-3 py-1.5 text-xs bg-red-500/10 text-red-400 border border-red-500/30 rounded-lg hover:bg-red-500/20 transition-colors font-medium"
              >
                Remove
              </button>
            </div>
      ...
      {error && (
        <div className="mt-2 text-xs text-red-400 bg-red-500/10 border border-red-500/20 rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2">
          {error}
        </div>
      )}
    </div>
